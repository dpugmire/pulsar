"""Pulsar's Trame application composition root."""
...
from config import (
    ...
    PULSAR_LLM_BASE_URL,
    PULSAR_LLM_MODEL,
    PULSAR_LLM_TIMEOUT_SECONDS,
    PULSAR_INTERACTION_LOG_DIR,
    PULSAR_INTERACTION_LOG_MAX_MB,
)
...
from . import module as pulsar_module
...
class PulsarApp(TrameApp):
    ...
    def __init__(
        ...
        self.server.enable_module(pulsar_module)
        ...
        print(f"Pulsar sidecar DB: {self.collection.path}")
        ...
        self.interaction_log = (
            ...
            if interaction_log is not None
                ...
                max_megabytes=PULSAR_INTERACTION_LOG_MAX_MB,
            )
        )
        ...
        self.query_translator = (
            ...
            or make_chat_completions_query_translator(
                model=PULSAR_LLM_MODEL,
                base_url=PULSAR_LLM_BASE_URL,
                api_key=PULSAR_LLM_API_KEY,
                timeout_seconds=PULSAR_LLM_TIMEOUT_SECONDS,
            )
        )
